...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ifcmzla.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ifcmzla.containers.anotherwebservice.com/
...
```
git clone git@github.com:barrencraw/container-ifcmzla.git
cd container-ifcmzla
```
...
```
docker attach container-ifcmzla
```
